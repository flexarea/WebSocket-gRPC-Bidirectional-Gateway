...
| Metric | gRPC only (ghz) | WS+gRPC total (k6) | gRPC layer (k6) | WS overhead | Delta (total) |
|--------|----------------|--------------------|-----------------|-------------|---------------|
| req/sec | 34,970 | 14,016 | — | — | -20,954 |
| p50 | 0.93ms | 3ms | 2.70ms | 0.30ms | +2.07ms |
| p90 | — | 4.99ms | 3.88ms | 1.11ms | — |
| p95 | 2.17ms | 5ms | 4.30ms | 0.70ms | +2.83ms |
